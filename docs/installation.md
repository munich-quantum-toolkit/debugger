...
To use the MQT Debugger Python package in your project,
...
- install MQT Debugger on your system
...
because it lets you detect installed versions of MQT Debugger
